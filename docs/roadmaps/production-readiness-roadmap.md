...
| Data views | Read-only saved-root, child-page, and value-read inspection is a production data-view contract through Marrow typed saved-data DTOs, data-view boundaries, watch targets, and checked-program admission. Remaining work is integrity/repair facts and debugger/runtime data-view contracts beyond read-only inspection, including served-process admission. |
