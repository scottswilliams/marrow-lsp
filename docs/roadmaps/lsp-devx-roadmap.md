...
- Resource hover and data explorer share bounded summary helpers for fields, layers, indexes, and
  key types.
...
- `/Users/scottwilliams/Dev/marrow-lsp/editors/vscode/src/dataExplorer.ts`
